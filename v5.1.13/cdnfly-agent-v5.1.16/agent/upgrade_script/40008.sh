...
upgrade_cmd() {
# lua_shared_dict log 10m;改lua_shared_dict log 50m;
sed -i 's/lua_shared_dict log.*/lua_shared_dict log 50m;/' /usr/local/openresty/nginx/conf/nginx.conf

#lua_shared_dict guard 100m;改lua_shared_dict guard 150m;
sed -i 's/lua_shared_dict guard.*/lua_shared_dict guard 150m;/' /usr/local/openresty/nginx/conf/nginx.conf
