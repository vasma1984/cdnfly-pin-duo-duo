...
if check_sys sysRelease ubuntu || check_sys sysRelease debian;then
    sed -i '/maxmind.com/d' /var/spool/cron/crontabs/root
    service cron restart
elif check_sys sysRelease centos; then
    sed -i '/maxmind.com/d' /var/spool/cron/root
...
chmod +x /opt/cdnfly/agent/sh/update_geoip.sh
/opt/cdnfly/agent/sh/update_geoip.sh
