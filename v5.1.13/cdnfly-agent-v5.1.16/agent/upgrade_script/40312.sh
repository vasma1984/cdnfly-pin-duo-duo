...
sed -i 's#http://#https://#g' $dir_name/agent/conf/filebeat.yml
sed -i '/monitor_pipeline/a\  ssl.verification_mode: none' $dir_name/agent/conf/filebeat.yml
