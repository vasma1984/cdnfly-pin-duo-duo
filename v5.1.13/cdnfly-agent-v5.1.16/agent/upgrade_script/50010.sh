...
upgrade_cmd() {
# filebeat.yml增加  http_headers: agent-pwd: 'ES_PWD'
ES_PWD=`awk -F'"' '/ES_PWD/{print $2}'  /opt/cdnfly/agent/conf/config.py`
sed -i "/verification_mode/a\  http_headers:\n    agent-pwd: '$ES_PWD'" /opt/cdnfly/agent/conf/filebeat.yml 
