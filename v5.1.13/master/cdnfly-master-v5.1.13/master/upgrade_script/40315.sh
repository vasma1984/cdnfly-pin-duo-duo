...
try:
    ...
    sql = '''
        alter table node_group add backup_switch_type varchar(20) default 'master_down' after des;
        alter table node_group add backup_switch_policy varchar(80) default '{}' after backup_switch_type;
        alter table line add switch_at datetime;        
