...
# 目录改名
cd /opt
if [[ -L /opt/cdnfly ]];then
    rm -f cdnfly
    mv cdnfly-master-v5.0.4 cdnfly
fi

# config.py增加 INDEX_PATH
echo -e '\nINDEX_PATH="/console/index.html"' >> /opt/cdnfly/master/conf/config.py

# 更新panel
\cp /opt/$dir_name/master/panel/src/views/site/site/index.html /opt/cdnfly/master/panel/src/views/site/site/index.html
\cp /opt/$dir_name/master/panel/src/views/system/user/index.html /opt/cdnfly/master/panel/src/views/system/user/index.html
