...
try:
    ...
    sql = '''
        alter table site add CONSTRAINT `node_group_ibfk_8` FOREIGN KEY (`node_group_id`) REFERENCES `node_group` (`id`);
        alter table stream add CONSTRAINT `node_group_ibfk_9` FOREIGN KEY (`node_group_id`) REFERENCES `node_group` (`id`);
