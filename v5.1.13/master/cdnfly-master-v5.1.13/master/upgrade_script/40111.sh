...
try:
    ...
    sql = '''
        drop table black_ip;
        drop table tmp_white_ip;
        CREATE TABLE `black_ip` (`id` bigint PRIMARY key auto_increment not null,`site_id` int(11) DEFAULT NULL,`ip` varchar(16) DEFAULT NULL,`fname` varchar(15) DEFAULT NULL,`uid` int(11) DEFAULT NULL,`exp` int(11) DEFAULT NULL,UNIQUE KEY `u_index` (`site_id`,`ip`,`fname`,`uid`),KEY `site_id_idx` (`site_id`),KEY `exp_idx` (`exp`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

        CREATE TABLE `tmp_white_ip` (`id` bigint PRIMARY key auto_increment not null,`site_id` int(11) DEFAULT NULL,`ip` varchar(16) DEFAULT NULL,`exp` int(11) DEFAULT NULL,UNIQUE KEY `u_index` (`site_id`,`ip`),KEY `site_id_idx` (`site_id`),KEY `exp_idx` (`exp`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;        
